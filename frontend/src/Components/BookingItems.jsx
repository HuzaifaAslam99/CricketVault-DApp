                ...
                {step === "form" && (
                    <form onSubmit={handleCheckout} className="flex flex-col flex-1 overflow-hidden">
                        ...
                        <div className="px-6 pb-6 pt-3 border-t border-white/5 shrink-0 space-y-3">
                            <button
                                type="submit"
                                className="w-full bg-[#d4af37] hover:bg-[#e8c547] text-black font-900 text-sm uppercase tracking-widest py-3.5 rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                            >
