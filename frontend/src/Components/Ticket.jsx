            ...
            <header className="sticky top-0 z-40 border-b border-white/5 bg-black/60 backdrop-blur-md">
                <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="relative flex items-center gap-2 bg-[#d4af37] hover:bg-[#e8c547] text-black font-800 text-xs uppercase tracking-widest px-4 py-2 rounded-sm transition-all active:scale-95"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="max-w-5xl mx-auto px-6 py-12">
                ...
                {totalCartItems > 0 && (
                    <div className="mt-8 sticky bottom-4">
                        <button
                            onClick={() => setShowCart(true)}
                            className="w-full bg-[#d4af37] hover:bg-[#e8c547] text-black font-900 text-base uppercase tracking-widest py-4 rounded-xl shadow-2xl transition-all active:scale-[0.98] flex items-center justify-center gap-3"
                        >
